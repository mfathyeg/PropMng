...
namespace PropMng.Web.Pages.HrArea.Inv
{
    public partial class Inv
    {
        ...
        private ItemsListModel<InvModel> ItemsList { get; set; } = new ItemsListModel<InvModel>();
        private InvModel Item { get; set; }
        ...
        private InvFilterModel f = new InvFilterModel();

        private string url = "Hr/Inv/";
        ...
        private async Task LoadItems()
        {
            ...
            if (resp.IsSucceed)
            {
                ItemsList = resp.GetDsrlzT<ItemsListModel<InvModel>>();
            }
        }
